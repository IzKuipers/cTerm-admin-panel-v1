<script lang="ts">
  ...
  function showUsers() {
    switchPage("userGetList");
  }
  function toggleUsers() {
    switchPage("userToggle");
  }
  function userBans() {
    switchPage("userBans");
  }
  function userCreate() {
    switchPage("userCreate");
  }
  function userDelete() {
    switchPage("userDelete");
  }
  function userPref() {
...
>
<button class="selectoption" on:click={userBans}>Ban or unban users</button><br
/>
